    ...
    public partial class Form1 : Form
    {
        ...
        private void btn_Registrar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string mensaje = "El usuario tiene que tener entre 4 y 10 carácteres en minúscula.";
                    string caption = "Atención";
                    MessageBoxButtons botones = MessageBoxButtons.OK;
                    DialogResult result = MessageBox.Show(mensaje, caption, botones);
        ...
        private void btn_Aceptar_Click(object sender, EventArgs e)
        {
            if (rdB_RegistrarSi.Checked && !txt_Email.Text.Equals(""))
            {
                ...
                {
                    string mensaje = "El email introducido no es una dirección de correo válida";
                    string caption = "Atención";
                    MessageBoxButtons botones = MessageBoxButtons.OK;
                    DialogResult result = MessageBox.Show(mensaje, caption, botones);
            ...
            {
                string mensaje = "Para registrar el usuario debe hacer clic en 'Sí' y escribir un email válido";
                string caption = "Atención";
                MessageBoxButtons botones = MessageBoxButtons.OK;
                DialogResult result = MessageBox.Show(mensaje, caption, botones);
        ...
        private void EnviarEmail()
        {
            ...
            MailMessage mail = new MailMessage("alejperezbirt@gmail.com", txt_Email.Text, "Clave privada", "Clave de acceso a contraseñas en el gestor de password");
        ...
        private void btn_Guardar_Click(object sender, EventArgs e)
        {
            if (!txt_Descripcion.Text.Equals("") && !txt_Contrasena02.Text.Equals(""))
            {
                ...
                {
                    string mensaje = "La contraseña debe estar formada por:\n" +
            ...
            {
                string mensaje = "Debes rellenar los campos descripción y contraseña antes de Guardar";
                string caption = "Atención";
                MessageBoxButtons botones = MessageBoxButtons.OK;
                DialogResult result = MessageBox.Show(mensaje, caption, botones);
        ...
        private void btn_Fichero_Click(object sender, EventArgs e)
        {
            ...
            {
                string mensaje = "Debes seleccionar una descripción de contraseña para desencriptar";
                string caption = "Atención";
                MessageBoxButtons botones = MessageBoxButtons.OK;
                DialogResult result = MessageBox.Show(mensaje, caption, botones);
            }
        ...
        private void btn_Borrar_Click(object sender, EventArgs e)
        {
            ...
            {
                string mensaje = "Debes seleccionar una descripción de contraseña para eliminar";
                string caption = "Atención";
                MessageBoxButtons botones = MessageBoxButtons.OK;
                DialogResult result = MessageBox.Show(mensaje, caption, botones);
            }
